...
const board = [
  {
    name:"Kaitlyn Youn",
    position: "President",
    email: "younk@bxscience.edu"
  },
  {
    name:"Ridwan Azam",
    position: "VP of Organization",
    email: "azamr@bxscience.edu"
  },
  {
    name:"Hannah Nadler",
    position: "VP of Tutoring",
    email: "nadlerh@bxscience.edu"
  },
  {
    name:"Jeffrey Li",
    position: "VP of Technology",
    email: "lij12@bxscience.edu"
  },
  {
    name:"Mr. DeSilva",
    position: "Advisor",
    email: "desilva@bxscience.edu"
  },
          ...
          <div class="board">
            ...
            <div class="flexbox-container">
              {board.map((person => (
                ...
                <div class="email"><u>{person.email}</u></div>
              </div>
              )))}
